<template>
  <div>
    <v-row>
      <v-col cols="5"></v-col>
      <v-col cols="2">
        <v-btn v-if="isEncrypted" @click="decryptClassicPic()">Bilder entschlüsseln</v-btn>
      </v-col>
      <v-col cols="5"></v-col>
    </v-row>
...
export default {
  ...
  methods: {
    ...
    decryptClassicPic() {
      ...
      store.commit('updateClassicDecrypted', this.decryptedImage)
